...
class KCard extends JPanel
{
	...
	KCard()
	{
		_suit = KCard.Suit.CLUBS;
		_value = KCard.Value.ACE;
		_faceup = false;
		_location = new Point();
		x = 0;
		y = 0;
	...
	public KCard setFaceup()
	{
		_faceup = true;
		return this;
	}

	public KCard setFacedown()
	{
		_faceup = false;
		return this;
	}
	...
	{
		Rectangle rect = new Rectangle(whereAmI.x, whereAmI.y, KCard.CARD_WIDTH, KCard.CARD_HEIGHT);
